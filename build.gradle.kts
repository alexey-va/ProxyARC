...
dependencies {
    ...
    implementation("ru.ruscrafting.arc:arc-core-metrics:2.7.11")
    implementation("ru.ruscrafting.arc:arc-core-redis:2.7.11")
    implementation("ru.ruscrafting.arc:arc-core-velocity:2.7.11")
    implementation("ru.ruscrafting.arc:arc-core-ai:2.7.11")
